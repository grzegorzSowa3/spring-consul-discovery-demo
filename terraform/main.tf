...
provider "helm" {
  kubernetes {
    ...
    host                   = data.google_container_cluster.vpc_native_cluster.endpoint
    cluster_ca_certificate = base64decode(data.google_container_cluster.vpc_native_cluster.master_auth[0].cluster_ca_certificate)
  }
}
